...
DETECTORS = {"Отклик": {"charge": 10, "price": 70}, "Медведь": {"charge": 15, "price": 170}, "Велес": {"charge": 20, "price": 320}, "Сварог": {"charge": 25, "price": 500}}
...
def get_emission_status():
    ...
    if emission_counter < 60:
        return "🟢"
    elif emission_counter < 120:
        return "🟡"
    elif emission_counter < 180:
        return "🟠"
    elif emission_counter < 240:
        return "🔴"
    elif emission_counter < 285:
        return "⚫"
    else:
        return "☠️"
