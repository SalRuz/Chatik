...
ITEM_EFFECTS = {"шоколадный батончик": {"hunger": -0.5}, "хлеб": {"hunger": -1}, "колбаса": {"hunger": -1.5}, "консерва": {"hunger": -2}, "бинт": {"health": 0.5}, "аптечка": {"health": 1}, "армейская аптечка": {"health": 1.5}, "научная аптечка": {"health": 1.5, "radiation": -0.5}, "сигареты": {"radiation": -0.5}, "водка": {"radiation": -1}, "радиопротектор": {"radiation": -1.5}, "антирад": {"radiation": -2}, "энергетик нонстоп": {"stamina": 3}, "энергетик сталкер": {"stamina": 5}, "геркулес": {"stamina": 7}, "батарейки": {}}
...
EXHAUSTION_LIMITS = {"База": 200,"Точка ресурсов": 150,"Территория": 100,"Логово": 50, "Аномальная зона": 20}
EMISSION_MAX = 300
