...
ITEM_ICONS = {"шоколадный батончик": "icons/chocolate.png", "Желудь": "icons/Желудь.png", "хлеб": "icons/bread.png", "колбаса": "icons/sausage.png", "консерва": "icons/canned_food.png", "бинт": "icons/bandage.png", "аптечка": "icons/first_aid.png", "армейская аптечка": "icons/army_medkit.png", "научная аптечка": "icons/science_medkit.png", "сигареты": "icons/cigarettes.png", "водка": "icons/vodka.png", "радиопротектор": "icons/radioprotector.png", "антирад": "icons/antirad.png", "энергетик нонстоп": "icons/energy_nostop.png", "энергетик сталкер": "icons/energy_stalker.png", "геркулес": "icons/hercules.png", "батарейки": "icons/battery.png", "пончик": "icons/Пончик.png", "стейк": "icons/Стейк.png"}
...
DROP_POLYANA_T = {"желудь": {"chance": 100, "min": 1, "max": 1}}
