...
CATEGORIES = {"еда": ["шоколадный батончик", "хлеб", "колбаса", "консерва", "геркулес"], "медикаменты": ["бинт", "аптечка", "армейская аптечка", "научная аптечка"], "антирад": ["сигареты", "водка", "радиопротектор", "антирад"], "энергетики": ["энергетик нонстоп", "энергетик сталкер"], "прочее": ["батарейки"], "артефакты": ALL_ARTIFACTS}
...
DROP_POLYANA_T = {"желудь": {"chance": 2, "min": 1, "max": 1}}
